...
import useRequestsPendingReimbursement from "./useRequestsPendingReimbursement";
...
const RequestsPendingReimbursement = () => {
  const { user } = useContext(AuthContext);
  const navigate = useNavigate();
  const DocName = "Requests Pending for Reimbursement";
  ...
  const {
    ...
    excelLoading,
    excelRef,
  } = useRequestsPendingReimbursement(
            ...
            <div className="main-container">
              ...
              >
                ...
                >
                  ...
                  <a href={excelData} ref={excelRef} download hidden>
                    Get Excel
                  </a>
                  <button
                    type="submit"
...
export default RequestsPendingReimbursement;
