      ...
      renderCell: (params) => {
        return (
          <div
            ...
            style={{ width: "100%" }}
          >
            {(params?.row?.status_id === 7 || params?.row?.status_id === 9) && (
              <a
                href={`/reimbursement-request/open-requests/resubmit/${params.row.id}`}
              >
                Resubmit
              </a>
            )}
...
export default useRejectedRequests;
