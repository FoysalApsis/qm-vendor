...
const Products = ({data,total}) => {
  ...
  return (
    ...
    <div className='mt-2 me-4 d-flex justify-content-end' style={{textAlign:"end"}}>
     ...
     {total && <table style={{width:"300px"}}>
        ...
        <tr>
          <td>Tax:</td>
          <td>$ {total?.groups_by_subtotal['Untaxed Amount'] ? total?.groups_by_subtotal['Untaxed Amount'][0].tax_group_amount : ""}</td>
        </tr>
